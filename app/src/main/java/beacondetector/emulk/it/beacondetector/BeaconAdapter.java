...
public class BeaconAdapter extends BaseAdapter {
    ...
    public BeaconAdapter(Context context, ArrayList<BeaconStructure> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.telemetryData = (TextView) convertView.findViewById(R.id.telemetryData);
